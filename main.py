...
def update_applicant(app_id=0):
    if request.method == "POST":
        data_manager.update_applicant_information(request.form['first_name'],request.form['last_name'], request.form['phone_number'], request.form['email'], request.form['application_code'], request.form['id'])
